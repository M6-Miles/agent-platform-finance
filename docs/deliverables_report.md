...
| 非金融复用 | Open-Meteo 天气 Demo 已接入 API 和前端，支持省/市/区定位与城市级回退 | 通过 |
| 单机部署 | Docker 单 worker、Nginx、可选 HTTPS、SQLite 持久化与每日备份；更新保留密钥和业务数据 | 通过 |
| 全量测试 | 1658 项收集，1657 passed，1 skipped，0 failed | 通过 |
