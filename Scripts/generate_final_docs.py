...
def summary_doc():
    ...
    table(d, ["门禁", "结果/状态", "证据"], [
        ("单元与集成测试", "1609 项收集；1608 passed，1 skipped，0 failed", "2026-08-14 pytest"),
...
def beginner_doc():
    ...
    callout(d, "当前事实", "截至 2026-08-14：1609 项测试收集，1608 passed、1 skipped、0 failed；正式样本外 Sharpe 约 -0.337，未达到 0.5；真实行情模拟盘证据为 1/7 天。", AMBER)
